...
For example, let's consider a scenario where the number of input variables `p = 240`, and the true parameters `beta` consist of `beta = 10` for the first 1/3, `beta = -10` for the next 1/3, and `beta = 0` for the remaining 1/3. Additionally, consider the sample size `n = 1200`.
