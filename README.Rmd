...
For example, let's consider a scenario where the number of input variables p = 360, and the true parameters consist of 10 for the first 1/3, -10 for the next 1/3, and 0 for the remaining 1/3. Additionally, consider the sample size n = 3000.
